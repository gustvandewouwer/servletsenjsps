...
public class PizzaBestellenServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (session != null) {
			System.out.println("PizzaBestellenServlet doGET - session != null");
			@SuppressWarnings("unchecked")
			Set<Long> mandje = (Set<Long>) session.getAttribute(MANDJE);
			if (mandje != null) {
				System.out.println("PizzaBestellenServlet doGET - mandje != null");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameterValues("id") != null) {
			...
			Set<Long> mandje = (Set<Long>) session.getAttribute(MANDJE);
			if (mandje == null) {
				System.out.println("PizzaBestellenServlet doPOST - mandje == null");
